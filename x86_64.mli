...
val jbe: label -> text  (* <= non signé *)
  (** sauts conditionnels *)
val cmove : [`Q] operand -> [`Q] operand  -> text  (* =  0 *)
val cmovz : [`Q] operand -> [`Q] operand  -> text  (* =  0 *)
val cmovne: [`Q] operand -> [`Q] operand  -> text  (* <> 0 *)
val cmovnz: [`Q] operand -> [`Q] operand  -> text  (* <> 0 *)
val cmovs : [`Q] operand -> [`Q] operand  -> text  (* <  0 *)
val cmovns: [`Q] operand -> [`Q] operand  -> text  (* >= 0 *)
val cmovg : [`Q] operand -> [`Q] operand  -> text  (* >  signé *)
val cmovge: [`Q] operand -> [`Q] operand  -> text  (* >= signé *)
val cmovl : [`Q] operand -> [`Q] operand  -> text  (* <  signé *)
val cmovle: [`Q] operand -> [`Q] operand  -> text  (* <= signé *)
val cmova : [`Q] operand -> [`Q] operand  -> text  (* >  non signé *)
val cmovae: [`Q] operand -> [`Q] operand  -> text  (* >= non signé *)
val cmovb : [`Q] operand -> [`Q] operand  -> text  (* <  non signé *)
val cmovbe: [`Q] operand -> [`Q] operand  -> text  (* <= non signé *)
